 ...
 */
public class PointsStyleAction extends AbstractAction implements RenderStyle {
     ...
     * @param statusBar the frame status bar
     */
    public PointsStyleAction(BrowserCore core, SwingStatusBar statusBar) {
        super("Points");
        ...
        putValue(SHORT_DESCRIPTION, "Points style rendering");
    }
    ...
    public void actionPerformed(ActionEvent evt) {
        if (!active) {
            ...
            statusBar.setStatusText("Point rendering mode enabled");
