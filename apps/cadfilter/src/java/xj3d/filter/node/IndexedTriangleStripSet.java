 ...
 */
public class IndexedTriangleStripSet extends BaseComposedGeometry {
     ...
     */
    public IndexedTriangleStripSet(String defName) {
        super("IndexedTriangleStripSet", defName);
    }
    ...
    public Encodable clone(boolean full) {
        IndexedTriangleStripSet itss = new IndexedTriangleStripSet();
        copy(itss, full);
        if (full) {
            if (index != null) {
                itss.num_index = this.num_index;
                itss.index = new int[this.num_index];
                System.arraycopy(this.index, 0, itss.index, 0, this.num_index);
            }
        }
        return(itss);
    }
