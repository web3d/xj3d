 ...
 */
public class MetadataFloat extends BaseMetadata {
     ...
     */
    public MetadataFloat(String defName) {
        super("MetadataFloat", defName);
    }
    ...
    public void setValue(String name, Object value) {
        ...
        if (name.equals("value")) {
            if (value instanceof String) {
                this.value = fieldReader.MFFloat((String)value);
    ...
    public Encodable clone(boolean full) {
        MetadataFloat mf = new MetadataFloat();
        copy(mf, full);
        if (full) {
            if (value != null) {
                mf.num_value = this.num_value;
                mf.value = new float[this.num_value];
                System.arraycopy(this.value, 0, mf.value, 0, this.num_value);
            }
        }
        return(mf);
    }
