 ...
 */
public class MetadataInteger extends BaseMetadata {
     ...
     */
    public MetadataInteger(String defName) {
        super("MetadataInteger", defName);
    }
    ...
    public void setValue(String name, Object value) {
        ...
        if (name.equals("value")) {
            if (value instanceof String) {
                this.value = fieldReader.MFInt32((String)value);
    ...
    public Encodable clone(boolean full) {
        MetadataInteger mi = new MetadataInteger();
        copy(mi, full);
        if (full) {
            if (value != null) {
                mi.num_value = this.num_value;
                mi.value = new int[this.num_value];
                System.arraycopy(this.value, 0, mi.value, 0, this.num_value);
            }
        }
        return(mi);
    }
