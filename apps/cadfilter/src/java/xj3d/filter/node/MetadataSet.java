 ...
 */
public class MetadataSet extends BaseMetadata {
     ...
     */
    public MetadataSet(String defName) {
        super("MetadataSet", defName);
    }
    ...
    public void setValue(String name, Object value) {
        ...
        if (name.equals("value")) {
            if (value instanceof IMetadata) {
                this.value = new IMetadata[]{(IMetadata)value};
                num_value = this.value.length;
            } else if (value instanceof IMetadata[]) {
                this.value = (Encodable[])value;
                num_value = this.value.length;
            }
        } else {
    ...
    public Encodable clone(boolean full) {
        ...
        if (full) {
            if (value != null) {
                ...
                ms.value = new IMetadata[this.num_value];
