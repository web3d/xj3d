 ...
 * 'standard' Construct.
 * <ul>
 * <li>A VirtualTimeSensorManager is integrated to support the
 * external control of the X3D scene time base.</li>
 ...
 */
public class OffscreenSceneRecorderConstruct extends OffscreenOGLConstruct
	implements ConfigGraphicsCapabilities {

    /** The logging identifier of this class */
    private static final String LOG_NAME = "OffscreenSceneRecorderConstruct";
     ...
     * @param height
     */
    public OffscreenSceneRecorderConstruct( ErrorReporter reporter, int width, int height ) {
