...
public class DemoApplet2 extends Applet {
	...
	*/
	...
	try {
	    ...
	    // LMS script node
	    node = browser.getNode("VC_Bolts_Trigger_LMSMarkSCOComplete_Script");

	    //XXX This is cosmoplayer specific.
	    node.getEventOut("LMSType").advise(new DemoObserver(), "SCO 02");
	} catch (Exception e) {
	    System.out.println("DemoApplet2 - " + e.toString());
	}
    }
	...
	System.out.println("Enter DemoApplet2's doLMSInitialize");
	//	changeLabel("Enter DemoApplet2's doLMSInitialize");

        if (jsRoot == null) {
	    System.out.println("Exit DemoApplet2's doLMSInitialize, jsRoot is null");
	    return;
	}
	...
	System.out.println("Exit DemoApplet2's doLMSInitialize");
	//	changeLabel("Exit DemoApplet2's doLMSInitialize");
    }

    public void doContinue(String task) {
        if (jsRoot == null) {
	    System.out.println("Exit DemoApplet2's doContinue, jsRoot is null");
	    return;
	}
