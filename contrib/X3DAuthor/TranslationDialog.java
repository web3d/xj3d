...
public class TranslationDialog extends JDialog {
    ...
    protected JTextField distanceEntry;
    ...
    public TranslationDialog(Frame owner,
			  String title,
			  boolean modal,
			  String nameData,
			  String distanceData) {
	...
	constraints.fill = GridBagConstraints.NONE;
	constraints.anchor = GridBagConstraints.EAST;
	distance = new JLabel("Distance (meters): ");
	mainPane.add(distance, constraints);
	...
	constraints.fill = GridBagConstraints.HORIZONTAL;
	constraints.anchor = GridBagConstraints.CENTER;
	distanceEntry = new JTextField();
	distanceEntry.setText(distanceData);
	mainPane.add(distanceEntry, constraints);
	...
	return distanceEntry.getText();
    }

    public void setDistance(String distance) {
	distanceEntry.setText(distance);
    }
