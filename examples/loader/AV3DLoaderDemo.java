    ...
    implements WindowListener, ApplicationUpdateObserver
{
    ...
    public AV3DLoaderDemo()
    {
        ...
        addWindowListener(AV3DLoaderDemo.this);
    ...
    private void load(String filename)
    {
        ...
        try
        {
            ...
            if(!loadAll && !externals.isEmpty())
            {
                File parent_dir = file.getParentFile();

                Set<Entry<SceneGraphObject, Object>> entries = externals.entrySet();
                Iterator<Entry<SceneGraphObject, Object>> itr = entries.iterator();

                while(itr.hasNext())
                {
                    Map.Entry<SceneGraphObject, Object> e = itr.next();
            ...
            if (size > 0) {
                ...
                runtimeComponents = rtComps.toArray(runtimeComponents);
        ...
        {
            System.err.println("IO Error reading file: " + tex_file);
