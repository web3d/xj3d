...
/** The BrowseFileAction is a simple ActionListener which
...
class BrowseFileAction implements ActionListener {
    ...
    /**
     * Shared chooser so that the last working directory is retained.
     */
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        switch (chooser.showOpenDialog((Component) (event.getSource()))) {
            case JFileChooser.APPROVE_OPTION:
                try {
                    urls[0] = chooser.getSelectedFile().toURI().toURL().toExternalForm();
