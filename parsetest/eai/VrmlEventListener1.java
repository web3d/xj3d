 ...
 *   This form of the test uses loadURL because at last version,
 *   replaceWorld still wasn't working correctly.
 *   Thus it is necessary to call loadURL, and then
...
public class VrmlEventListener1 implements vrml.eai.event.BrowserListener {
  public static void main(String[] args) {
    new VrmlEventListener1().performTest();
  }
