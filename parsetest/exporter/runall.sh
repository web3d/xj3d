CONVERTER="java -Xmx800M xj3d.filter.CDFFilter Identity"
...
$CONVERTER DiamondManLOA-0.wrl output_x3dv/DiamondManLOA-0.x3dv -upgradeContent
...
echo DiamondManLOA-0.wrl
$CONVERTER DiamondManLOA-0.wrl output_x3d/DiamondManLOA-0.x3d -upgradeContent
...
echo DiamondManLOA-0.wrl
$CONVERTER DiamondManLOA-0.wrl output_x3db/DiamondManLOA-0.x3db -upgradeContent
