...
/**
 * A demo utility for MFVec3f and Coordinate. All this class does is wait for an
 * event on its MFVec3f input, do some preselected manipulation on that event's
 * value, and then send the event off to its output. A thread.sleep is thrown in
 * to avoid running too fast, but it would be much better to do this work in a
 * seperate process.
 * <P>
