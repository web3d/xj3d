...
/**
 * ***************************************************************************
 * Copyright North Dakota State University, 2004 Written By Bradley Vender
...
/**
 * Simple utility to allow waiting for the browserInitialized event rather than
 * putting code in a browser listener.
 */
public class SAIBrowserInitWaiter implements BrowserListener {
    ...
    /**
     * * @see
     * org.web3d.x3d.sai.BrowserListener#browserChanged(org.web3d.x3d.sai.BrowserEvent)
     */
    @Override
