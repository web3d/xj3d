 ...
 * <P>
 * Most importantly, this test should plod along at moving two points per
 * second. If it speeds up, that means that the set1Value coalescing isn't
 * working correctly.
 */
public class SAICoordinateTest2 {
    ...
    // Gosh its annoying to walk down to a Coordinate node from
        ...
        coordOutput.addX3DEventListener(
                new BasicSAICoordinateMutator(browser, coordOutput, coordInput, 2)
        );
