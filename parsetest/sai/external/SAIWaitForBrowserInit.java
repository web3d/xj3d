...
/**
 * Simple listener to wait for the browser to generate an initialization event
 * rather than putting demo code in a callback. Create an instance of this
 * class, call replaceWorld, and then call waitForInit().
 *
 */
public class SAIWaitForBrowserInit implements BrowserListener {
     ...
     *
     * @see
     * vrml.eai.event.BrowserListener#browserChanged(vrml.eai.event.BrowserEvent)
     */
    ...
    /**
     * wait() until the initialize event is sent, or return immediately if it
     * was already seen.
     */
