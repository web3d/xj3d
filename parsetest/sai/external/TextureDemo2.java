 ...
 *
 * Please note that driving a Java3D based engine like this at full speed while
 * randomly changing the texture sizes will cause the system to run out of
 * memory in a few minutes. The author of this demo believes that this is
 * because of a non-zero delay between the setting and applying of a texture in
 * Java3D, and not the result of any buffering problems.
 *
...
public class TextureDemo2 {
    ...
    public static void main(String[] args) {
        ...
        // need to trigger an event first.
