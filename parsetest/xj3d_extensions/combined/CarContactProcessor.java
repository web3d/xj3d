...
public class CarContactProcessor implements X3DFieldEventListener {
    ...
    private Set<X3DNode> terrainObjects;
     ...
     * @param fields
     */
    public void initialize(Map<String, X3DField> fields) {
        ...
        int num_terrain = terrain_field.getSize();
    ...
    public void readableFieldChanged(X3DFieldEvent evt) {
        int num_contacts = contactInput.getSize();
