...
import org.web3d.util.spatial.Vec3DDouble.Axis;
import toxi.math.InterpolateStrategy;
import toxi.math.MathUtils;
import toxi.math.ScaleMap;

/**
 * Readonly, immutable interface wrapper for Vec3DDouble instances. Used throughout
 * the library for safety purposes.
 */
public interface ReadonlyVec3DDouble {
     ...
     */
    Vec3DDouble add(double a, double b, double c);
     ...
     * alternative implementation {@link #angleBetween(ReadonlyVec3DDouble, boolean)}
     *
     * @param v
     *            vector
     *
     ...
     */
    double angleBetween(ReadonlyVec3DDouble v);
     ...
     * @return angle in radians, or NaN if vectors are parallel
     */
    double angleBetween(ReadonlyVec3DDouble v, boolean forceNormalize);
     ...
     */
    int compareTo(ReadonlyVec3DDouble v);
     ...
     */
    Vec3DDouble cross(ReadonlyVec3DDouble v);
     ...
     */
    Vec3DDouble crossInto(ReadonlyVec3DDouble v, Vec3DDouble result);
     ...
     */
    double distanceTo(ReadonlyVec3DDouble v);
     ...
     * @see #magSquared()
     */
    double distanceToSquared(ReadonlyVec3DDouble v);
     ...
     *      entry</a>
     */
    double dot(ReadonlyVec3DDouble v);
     ...
     */
    boolean equalsWithTolerance(ReadonlyVec3DDouble v, double tolerance);
     ...
     * @return new vector
     */
    Vec3DDouble getCartesian();

    double getComponent(Axis id);
     ...
     */
    Vec3DDouble getConstrained(AABB box);
     ...
     * @return result as new vector
     */
    Vec3DDouble getLimited(double lim);
     ...
     */
    Vec3DDouble getMapped(ScaleMap map);
     ...
     * @return new vector
     */
    Vec3DDouble getNormalizedTo(double len);
     ...
     * @return new vector
     */
    Vec3DDouble getReciprocal();

    Vec3DDouble getReflected(ReadonlyVec3DDouble normal);
     ...
     */
    Vec3DDouble getRotatedAroundAxis(ReadonlyVec3DDouble axis, double theta);
     ...
     */
    Vec3DDouble getRotatedX(double theta);
     ...
     * @return rotated vector
     */
    Vec3DDouble getRotatedY(double theta);
     ...
     * @return rotated vector
     */
    Vec3DDouble getRotatedZ(double theta);
     ...
     */
/*
    Vec3DDouble getRoundedTo(double prec);
*/
     ...
     * @return result as new vector
     */
    Vec3DDouble interpolateTo(ReadonlyVec3DDouble v, double f);
     ...
     * @return result as new vector
     */
    Vec3DDouble interpolateTo(ReadonlyVec3DDouble v, double f, InterpolateStrategy s);
    ...
    boolean isInAABB(Vec3DDouble boxOrigin, Vec3DDouble boxExtent);
     ...
     */
    boolean isMajorAxis(double tolerance);
     ...
     * @return new vector
     */
    Vec3DDouble scale(double a, double b, double c);
     ...
     * @return new vector
     */
    Vec3DDouble scale(ReadonlyVec3DDouble s);
     ...
     * @return result as new vector
     */
    Vec3DDouble sub(double a, double b, double c);
     ...
     * @return result as new vector
     */
    Vec3DDouble sub(ReadonlyVec3DDouble v);
