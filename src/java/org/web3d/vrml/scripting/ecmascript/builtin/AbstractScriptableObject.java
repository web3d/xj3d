...
public abstract class AbstractScriptableObject implements Scriptable {
     ...
     * an Ecmascript call.
     * @param name the class name of the script
     */
     ...
     * idea.
     * @return default value for this (Abstract value is null)
     */
    @Override
     ...
     * @param start the script corresponding to the given name
     ...
     * instance.
     * @param parent new value for parentScope
     */
    @Override
