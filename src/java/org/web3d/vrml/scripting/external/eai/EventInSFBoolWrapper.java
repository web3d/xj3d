...
/**
 *  EventInSFBoolWrapper provides the functional implementation of
 *  EventInSFBool for the SimpleBrowser class.  The functionality of this class
 *  is specified in the EAI 2.0 specification.
 */

class EventInSFBoolWrapper extends EventInSFBool 
implements ExternalEvent, EventWrapper {
    ...
    */
    EventInSFBoolWrapper(
        VRMLNodeType aNode, int id, ExternalEventQueue aQueue, boolean newValue
    ) {
    ...
    /** @see vrml.eai.field.EventInSFBool#setValue */
    @Override
    public void setValue(boolean newValue) {
        ...
        if (!hasStoredValue) {
            ...
            queuedElement=new EventInSFBoolWrapper(
    ...
    /** Store a value in this EventIn as a place holder for the buffering 
      * system.  */
    private void storeValue(boolean newValue) {
        hasStoredValue=true;
