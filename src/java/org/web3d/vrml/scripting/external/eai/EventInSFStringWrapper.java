...
/**
 *  EventInSFStringWrapper provides the functional implementation of
 *  EventInSFString for the SimpleBrowser class.  The functionality of this 
 *  class is specified in the EAI 2.0 specification.
 */

class EventInSFStringWrapper extends EventInSFString 
implements ExternalEvent, EventWrapper {
    ...
    */
    ...
    /** Constructor for use in event queueing system.
      ...
      * @param id The underlying target field
      * @param aQueue The queue to send events to
      * @param aValue The value for this event
      */
    EventInSFStringWrapper(
        VRMLNodeType aNode, int id, ExternalEventQueue aQueue, String aValue
    ) {
    ...
    /** @see vrml.eai.field.EventInSFString#setValue */
    @Override
    public void setValue(String newValue) {
        ...
        if (!hasStoredValue) {
            ...
            queuedElement=new EventInSFStringWrapper(
    ...
    */
    private void storeValue(String aValue) {
        storedValue=aValue;
        hasStoredValue=true;
    }
