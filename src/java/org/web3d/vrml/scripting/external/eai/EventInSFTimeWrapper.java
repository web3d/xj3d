...
/**
 *  EventInSFTimeWrapper provides the functional implementation of
 *  EventInSFTime for the SimpleBrowser class.  The functionality of this class
 *  is specified in the EAI 2.0 specification.
 */

class EventInSFTimeWrapper extends EventInSFTime 
implements ExternalEvent, EventWrapper {
    ...
    /** Constructor for use in event queueing system.
      ...
      */
    EventInSFTimeWrapper(
        VRMLNodeType aNode, int id, ExternalEventQueue aQueue, double aValue
    ) {
    ...
    /** @see vrml.eai.field.EventInSFTime#setValue */
    @Override
    public void setValue(double newValue) {
        ...
        if (!hasStoredValue) {
            ...
            queuedElement=new EventInSFTimeWrapper(
    ...
    /** Store a value in this EventIn as a place holder for the buffering 
      ...
      */
    private void storeValue(double aValue) {
        storedValue=aValue;
        hasStoredValue=true;
    }
