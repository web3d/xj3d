...
/**
 *  EventInSFVec3fWrapper provides the functional implementation of
 *  EventInSFVec3f for the SimpleBrowser class.  The functionality of this class
 *  is specified in the EAI 2.0 specification.
 */

class EventInSFVec3fWrapper extends EventInSFVec3f
implements ExternalEvent, EventWrapper {
    ...
    public void doEvent() {
        try {
            try {
                theNode.setValue(theFieldID,storedValue,3);
            } finally {
    ...
    /** @see vrml.eai.field.EventInSFVec3f#setValue */
    @Override
    public void setValue(float[] newValue) {
        ...
        if (!hasStoredValue) {
            ...
            queuedElement=new EventInSFVec3fWrapper(
