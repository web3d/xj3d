...
/**
 *  EventOutMFInt32Wrapper provides the functional implementation of
 *  EventOutMFInt32 for the SimpleBrowser class.  The functionality of this 
 *  class is specified in the EAI 2.0 specification.
 */

class EventOutMFInt32Wrapper extends EventOutMFInt32 
implements ExternalOutputBuffer, EventWrapper {
    ...
    /** @see vrml.eai.field.EventOutMFInt32#get1Value */
    @Override
        ...
        if (isStored)
            ...
            try {
                ...
                if (index<0 || index>=fieldData.numElements)
                    ...
                    return fieldData.intArrayValues[index];
            } catch (InvalidFieldException ife) {
                throw new RuntimeException("Error reading field value");
            }
    }

    /** @see vrml.eai.field.EventOutMFInt32#getValue */
    @Override
    public void getValue(int dest[]) {
        if (isStored)
            ...
            try {
                ...
                if (fieldData.numElements!=0)
                	System.arraycopy(fieldData.intArrayValues,0,dest,0,fieldData.numElements
                	);
            } catch (InvalidFieldException ife) {
