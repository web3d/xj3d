...
/**
 *  EventOutMFStringWrapper provides the functional implementation of
 *  EventOutMFString for the SimpleBrowser class.  The functionality of this 
 *  class is specified in the EAI 2.0 specification.
 */

class EventOutMFStringWrapper extends EventOutMFString 
implements ExternalOutputBuffer, EventWrapper {
    ...
    /** @see vrml.eai.field.EventOutMFString#get1Value */
    @Override
        ...
        if (isStored)
            ...
            try {
                ...
                if (index<0 || index>=fieldData.numElements)
                    ...
                    return fieldData.stringArrayValues[index];
            } catch (InvalidFieldException ife) {
                throw new RuntimeException("Error getting field value");
            }
    }

    /** @see vrml.eai.field.EventOutMFString#getValue */
    @Override
    ...
    /** @see vrml.eai.field.EventOutMFString#getValue */
    @Override
    public void getValue(String[] dest) {
        if (isStored)
            ...
            try {
                ...
                if (fieldData.numElements!=0)
                	System.arraycopy(fieldData.stringArrayValues,0,dest,0,fieldData.numElements
                	);
            } catch (InvalidFieldException ife) {
                throw new RuntimeException("Error getting field value.");
            }
