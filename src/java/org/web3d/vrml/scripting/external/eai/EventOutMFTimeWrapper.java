...
/**
 *  EventOutMFTimeWrapper provides the functional implementation of
 *  EventOutMFTime for the SimpleBrowser class.  The functionality of this class
 *  is specified in the EAI 2.0 specification.
 */

class EventOutMFTimeWrapper extends EventOutMFTime 
implements ExternalOutputBuffer, EventWrapper {
    ...
    /** @see vrml.eai.field.EventOutMFTime#get1Value */
    @Override
    public double get1Value(int index) {
        if (isStored)
            ...
            try {
                ...
                return fieldData.doubleArrayValues[index];
            } catch (InvalidFieldException ife) {
                throw new RuntimeException("Error reading field value");
        }
    }

    /** @see vrml.eai.field.EventOutMFTime#getValue */
    @Override
    public void getValue(double dest[]) {
        if (isStored)
            ...
            try {
                ...
                if (fieldData.numElements!=0)
                	System.arraycopy(fieldData.doubleArrayValues, 0, dest, 0, 
