...
/**
 *  EventOutSFBoolWrapper provides the functional implementation of
 *  EventOutSFBool for the SimpleBrowser class.  The functionality of this class
 *  is specified in the EAI 2.0 specification.
 */

class EventOutSFBoolWrapper extends EventOutSFBool 
implements ExternalOutputBuffer, EventWrapper {
    ...
    /** @see vrml.eai.field.EventOutSFBool#getValue */
    @Override
    public boolean getValue() {
        if (isStored)
            ...
            try {
                return theNode.getFieldValue(theFieldID).booleanValue;
