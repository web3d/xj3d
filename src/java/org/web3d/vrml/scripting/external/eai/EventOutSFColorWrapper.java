...
/**
 *  EventOutSFColorWrapper provides the functional implementation of
 *  EventOutSFColor for the SimpleBrowser class.  The functionality of this 
 *  class is specified in the EAI 2.0 specification.
 */

class EventOutSFColorWrapper extends EventOutSFColor 
        ...
        if (isStored) {
            ...
            try {
            	...
            	if (value.floatArrayValues==null)
            		...
            		System.arraycopy(value.floatArrayValues,0,dest,0,3);
