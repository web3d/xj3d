...
/**
 *  EventOutSFFloatWrapper provides the functional implementation of
 *  EventOutSFFloat for the SimpleBrowser class.  The functionality of this 
 *  class is specified in the EAI 2.0 specification.
 */

class EventOutSFFloatWrapper extends EventOutSFFloat 
implements ExternalOutputBuffer, EventWrapper {
    ...
    public float getValue() {
        if (isStored)
            ...
            try {
                return theNode.getFieldValue(theFieldID).floatValue;
