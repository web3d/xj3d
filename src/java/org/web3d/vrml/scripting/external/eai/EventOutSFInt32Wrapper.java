...
/**
 *  EventOutSFInt32Wrapper provides the functional implementation of
 *  EventOutSFInt32 for the SimpleBrowser class.  The functionality of this 
 *  class is specified in the EAI 2.0 specification.
 */

class EventOutSFInt32Wrapper extends EventOutSFInt32 
implements ExternalOutputBuffer, EventWrapper {
    ...
    /** @see vrml.eai.field.EventOutSFInt32#getValue */
    @Override
    public int getValue() {
        if (isStored)
            return storedValue;
            ...
            try {
                return theNode.getFieldValue(theFieldID).intValue;
