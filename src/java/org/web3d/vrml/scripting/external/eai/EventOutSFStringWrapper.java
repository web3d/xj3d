...
/**
 *  EventOutSFStringWrapper provides the functional implementation of
 *  EventOutSFString for the SimpleBrowser class.  The functionality of this 
 *  class is specified in the EAI 2.0 specification.
 */

class EventOutSFStringWrapper extends EventOutSFString 
implements ExternalOutputBuffer, EventWrapper {
    ...
    /** @see vrml.eai.field.EventOutSFString#getValue */
    @Override
    public String getValue() {
        if (isStored)
            ...
            try {
                return theNode.getFieldValue(theFieldID).stringValue;
