 ...
 */
public class EventInMFTimeWrapper extends EventInMFTime
    ...
    public void set1Value(int index, double value) throws ArrayIndexOutOfBoundsException {
            synchronized(eventQueue.eventLock) {
                EventInMFTimeWrapper queuedElement=(EventInMFTimeWrapper)
