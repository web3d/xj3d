...
public class EventInSFBoolWrapper extends EventInSFBool 
    ...
    /** * @see vrml.eai.field.EventInSFBool#setValue(boolean)  */
    @Override
    public void setValue(boolean value) {
        EventInSFBoolWrapper queuedElement;
        if (!hasStoredValue)
            queuedElement=this;
        else
            queuedElement=new EventInSFBoolWrapper(fieldID,requestProcessor,eventQueue);
    ...
    public void writeFieldValue(DataOutputStream output) throws IOException {
        output.writeBoolean(storedValue);
    }
