 ...
 */
public class EventInSFNodeWrapper extends EventInSFNode 
    ...
    @Override
    public void setValue(Node value) throws InvalidNodeException {
        EventInSFNodeWrapper queuedElement;
        if (!hasStoredValue)
            queuedElement=this;
        else
            queuedElement=new EventInSFNodeWrapper(fieldID,requestProcessor,eventQueue,nodeFactory);
