...
import vrml.eai.field.EventInSFString;
 ...
 */
public class EventInSFStringWrapper extends EventInSFString 
    ...
    /** * @see vrml.eai.field.EventInSFString#setValue(java.lang.String)  */
    @Override
    public void setValue(String value) {
        EventInSFStringWrapper queuedElement;
        if (!hasStoredValue)
            queuedElement=this;
        else
            queuedElement=new EventInSFStringWrapper(fieldID,requestProcessor,eventQueue);
