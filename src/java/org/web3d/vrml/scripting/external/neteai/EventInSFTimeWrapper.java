...
public class EventInSFTimeWrapper extends EventInSFTime 
    ...
    @Override
    public void setValue(double value) throws InvalidNodeException {
        EventInSFTimeWrapper queuedElement;
        if (!hasStoredValue)
            queuedElement=this;
        else
            queuedElement=new EventInSFTimeWrapper(fieldID,requestProcessor,eventQueue);
    ...
    public void writeFieldValue(DataOutputStream output) throws IOException {
        output.writeDouble(storedValue);
    }
