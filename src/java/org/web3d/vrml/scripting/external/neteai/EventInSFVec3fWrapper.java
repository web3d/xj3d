 ...
 */
public class EventInSFVec3fWrapper extends EventInSFVec3f 
    ...
    /** * @see vrml.eai.field.EventInSFVec3f#setValue(float[])  */
    @Override
    public void setValue(float[] value) {
        EventInSFVec3fWrapper queuedElement;
        if (!hasStoredValue)
            queuedElement=this;
        else
            queuedElement=new EventInSFVec3fWrapper(fieldID,requestProcessor,eventQueue);
