 ...
 * */
public class EventOutMFColorWrapper extends EventOutMFColor 
    ...
    /**
     * @return  * @see vrml.eai.field.EventOutMFColor#getValue()  */
    @Override
    ...
    /** * @see vrml.eai.field.EventOutMFColor#getValue(float[][])  */
    @Override
    public void getValue(float[][] col) {
        if (!hasStoredValue)
            requestProcessor.getFieldValue(fieldID,this);
        ArrayUtils.raise3(storedValue,storedValue.length/3,col);
    }
    ...
    public void getValue(float[] col) {
        if (!hasStoredValue)
            requestProcessor.getFieldValue(fieldID,this);
        System.arraycopy(storedValue,0,col,0,storedValue.length);
    }

    /**
     * @return  * @see vrml.eai.field.EventOutMFColor#get1Value(int)  */
    @Override
    ...
    /** * @see vrml.eai.field.EventOutMFColor#get1Value(int, float[])  */
    @Override
    public void get1Value(int index, float[] col) {
        if (!hasStoredValue)
            requestProcessor.getFieldValue(fieldID,this);
        System.arraycopy(storedValue,index*3,col,0,3);
    }
    ...
    public void loadFieldValue(DataInputStream input) throws IOException {
        ...
        storedValue=new float[3*numFields];
        for (int counter=0; counter<storedValue.length; counter++)
