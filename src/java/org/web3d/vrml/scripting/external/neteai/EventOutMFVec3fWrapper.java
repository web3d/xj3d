...
import vrml.eai.field.EventOutMFVec3f;
 ...
 */
public class EventOutMFVec3fWrapper extends EventOutMFVec3f 
    ...
    /**
     * @return  * @see vrml.eai.field.EventOutMFVec3f#getValue()  */
    @Override
    ...
    /** * @see vrml.eai.field.EventOutMFVec3f#getValue(float[][])  */
    @Override
    public void getValue(float[][] vec) {
        if (!hasStoredValue)
            requestProcessor.getFieldValue(fieldID,this);
        ArrayUtils.raise3(storedValue,storedValue.length/3,vec);
    }
    ...
    /**
     * @return  * @see vrml.eai.field.EventOutMFVec3f#get1Value(int)  */
    @Override
    ...
    /** * @see vrml.eai.field.EventOutMFVec3f#get1Value(int, float[])  */
    @Override
    public void get1Value(int index, float[] vec) {
        if (!hasStoredValue)
            requestProcessor.getFieldValue(fieldID,this);
        System.arraycopy(storedValue,index*3,vec,0,3);
    }
    ...
    public void loadFieldValue(DataInputStream input) throws IOException {
        ...
        storedValue=new float[3*numValues];
        int innerCounter=0;
