...
public class EventOutSFImageWrapper extends EventOutSFImage 
    ...
    /**
     * @return  * @see vrml.eai.field.EventOutSFImage#getWidth()  */
    @Override
    public int getWidth() {
        if (hasStoredValue)
    ...
    /**
     * @return  * @see vrml.eai.field.EventOutSFImage#getHeight()  */
    @Override
    ...
    /**
     * @return  * @see vrml.eai.field.EventOutSFImage#getComponents()  */
    @Override
    ...
    /**
     * @return  * @see vrml.eai.field.EventOutSFImage#getPixels()  */
    @Override
