...
import vrml.eai.field.EventOutSFRotation;
 ...
 */
public class EventOutSFRotationWrapper extends EventOutSFRotation 
     ...
     */
    public EventOutSFRotationWrapper(
        int fieldID, 
        FieldAndNodeRequestProcessor requestProcessor
    ) {
    ...
    public EventOutSFRotationWrapper(
        int fieldID, 
        FieldAndNodeRequestProcessor requestProcessor, 
        DataInputStream source) throws IOException {
    ...
    /**
     * @return  * @see vrml.eai.field.EventOutSFRotation#getValue()  */
    @Override
    ...
    /** * @see vrml.eai.field.EventOutSFRotation#getValue(float[])  */
    @Override
    public void getValue(float[] vec) {
        if (!hasStoredValue)
            requestProcessor.getFieldValue(fieldID,this);
        System.arraycopy(storedValue,0,vec,0,4);
    }
