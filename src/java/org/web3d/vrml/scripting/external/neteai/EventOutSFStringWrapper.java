...
import vrml.eai.field.EventOutSFString;
 ...
 */
public class EventOutSFStringWrapper extends EventOutSFString 
     ...
     */
    public EventOutSFStringWrapper(
        int fieldID, 
        FieldAndNodeRequestProcessor requestProcessor
    ) {
    ...
    /**
     * @return  * @see vrml.eai.field.EventOutSFString#getValue()  */
    @Override
