...
public interface FieldAndNodeRequestProcessor {
     ...
     */
    EventIn getEventIn(int nodeID, String fieldName);
     ...
     */
    EventOut getEventOut(int nodeID, String fieldName);
     ...
     */
    void setFieldValue(int fieldID, EventWrapper buffer);
     ...
     */
    void getFieldValue(int fieldID, EventWrapper buffer);
     ...
     */
    void removeVrmlEventListener(int fieldID, VrmlEventListener l);
     ...
     */
    void addVrmlEventListener(int fieldID, int fieldType, VrmlEventListener l);
     ...
     */
    int getNumFieldValues(int fieldID);
     ...
     */
    int getImageComponents(int fieldID);
     ...
     */
    int getImageHeight(int fieldID);
