...
public class FieldToVRMLNodeTypeMapper {
     ...
     */
    IntHashMap<VRMLNodeTypeAdapter> fieldIDToAdapterTable;
     ...
     * stores the information for the reverse retrieval in findNode.
     * @param adapter The adapter containing the field
    ...
    VRMLNodeTypeAdapter findNode(int fieldID) {
        return fieldIDToAdapterTable.get(fieldID);
    }
