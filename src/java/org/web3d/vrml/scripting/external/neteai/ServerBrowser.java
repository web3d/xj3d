...
public class ServerBrowser {
    ...
    IntHashMap<VRMLNodeTypeAdapter> nodeAdapterTable;
    ...
    IntHashMap<VRMLNodeType> nodeIDToNodeTable;
    ...
    void disposeNode(int nodeID) throws InvalidNodeException {
            VRMLNodeType node=nodeIDToNodeTable.get(nodeID);
            if (node==null)
    ...
    int getEventIn(int nodeID, String fieldName) {
        ...
        VRMLNodeTypeAdapter adapter=nodeAdapterTable.get(nodeID);
        if (adapter==null) {
     ...
     * @return a VRMLNodeType from given index
     */
    ...
    public int generateNodeID(VRMLNodeType node) {
        ...
        if (oldID!=null)
            ...
            nodeToNodeIDTable.put(node, nodeID);
            return nodeID;
        }
    }
