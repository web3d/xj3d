...
/**
 * Simple queue element for posting RemoveRoute calls
 *
 * @author Alan Hudson
 * @version $Revision: 1.3 $
 */
class RemoveRouteEvent implements ExternalEvent {

    /** The routeManager to use */
    private RouteManager routeManager;

    /** The space to Remove to */
     ...
     */
    RemoveRouteEvent(RouteManager rm,
    ...
    @Override
    public void doEvent() {
        routeManager.removeRoute(space,
                              srcNode,
                              srcIdx,
                              destNode,
                              destIdx);
