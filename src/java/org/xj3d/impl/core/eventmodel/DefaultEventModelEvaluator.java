...
public class DefaultEventModelEvaluator implements EventModelEvaluator {
    ...
    private Map<VRMLNode, BasicScene> scriptToSceneMap;
     ...
     */
    private Map<BasicScene, HashSet<VRMLNode>> sceneToScriptListMap;
    ...
    private Map<VRMLNode, LayerManager> layerToRendererMap;
    ...
    private IntHashMap<List<NodeObserver>> nodeObserverMap;
