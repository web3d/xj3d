...
public class DefaultRigidBodyPhysicsManager implements NodeManager {
    ...
    // TODO: A seemingly harmless WARN msg is generated when we destroy
    // and rebuild Xj3D in the same JVM session.  Ode.dCloseODE() is
    // called here and is never reinitialized when we rebuild and Xj3DBrowser
    // instance.
    @Override
