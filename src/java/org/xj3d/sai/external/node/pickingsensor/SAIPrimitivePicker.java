...
/** A concrete implementation of the PrimitivePicker node interface
 * @author Rex Melton
 * @version $Revision: 1.1 $ */
public class SAIPrimitivePicker extends SAINode implements PrimitivePicker {
